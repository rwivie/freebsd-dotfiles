...
static const Key keys[] = {
	...
	{ 0,				XF86XK_AudioStop,	   spawn,	  SHCMD("mpc stop") },
        ...
        { 0,                            XF86XK_AudioLowerVolume,   spawn,         SHCMD("bash -c 'pamixer --decrease 5; ~/.config/sway/scripts/audio-notification-5.sh'; kill -44 $(pidof dwmblocks)") },
        { 0,                            XF86XK_AudioRaiseVolume,   spawn,         SHCMD("pactl set-sink-mute 0 false ; bash -c 'pamixer --increase 5; ~/.config/sway/scripts/audio-notification-5.sh'; kill -44 $(pidof dwmblocks)") },
